			...
			<div class="col-lg-7">
				...
				<form class="register__form">
					<label class="input register__form-field has-error">
						...
						<input type="email" name="user_name" class="input__field input__big element-blur input__field-blue" placeholder="konstantin.konstantinovich@gmail.com">
                        @error('password')
						<span class="input__error">обязательно к заполнению</span>
                        @enderror
					</label>
					<label class="input register__form-field">
						<span class="input__title" >Логин</span>
						<input type="text" name="name" class="input__field input__big element-blur input__field-blue" placeholder="Придумайте логин">
					</label>
					<label class="input register__form-field js-input-password">
						...
						<span class="input__field-wrapper">
							...
							<input type="password" name="password" class="input__field input__big element-blur input__field-blue js-input-password-field" placeholder="Придумайте пароль">
					...
					<label class="input register__form-field js-input-password">
						...
						<span class="input__field-wrapper">
							<img src="/img/new/icons/icon-lock-accent.svg" alt="alt" class="input__icon">
							<input type="password" name="password_confirmation" class="input__field input__big element-blur input__field-blue js-input-password-field" placeholder="Повторите придуманный пароль">
							<span class="input__control js-input-password-toggler icon-mask"></span>
						</span>
					</label>
					<input type="submit" value="Зарегистрироваться" class="btn btn-big btn-fill-blue register__submit">
				</form>
			</div>
			<div class="col-lg-5">
				<div class="register__sidebar register__sidebar-offset c-white">
					<div class="h3 register__sidebar-title">У вас уже есть учётная запись?</div>
					<div class="register__sidebar-descr">Авторизируйтесь, что бы воспользоваться всеми функцииями и привилегиями платформы</div>
					<a href="login.html" class="btn btn-big btn-block btn-fill-white register__sidebar-btn">Авторизация</a>
				</div>
			</div>
		</div>
	</div>
