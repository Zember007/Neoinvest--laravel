...
<x-guest-layout>
    <div class="f">
        <form action="{{ $submitTo }}" method="POST">
            ...
            <div class="f-que"
                 style="margin-bottom: 40px;">@lang('auth.phone_verification_notice', ['phone' => $login])</div>
                ...
                <div class="modal__wrapper">
                    <div class="modal confirm">
                        ...
                        <div class="modal__inner">
                            <div class="modal-title">@lang('auth.in_order_to_change_phone')</div>

                            @livewire('change-login-form', ['mode' => 'phone'])
                        </div>
                    </div>
                </div>
            </div>
